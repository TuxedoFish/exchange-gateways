...
CONFIG="md-process-hyperliquid-test"
PROCESSED_DIR="/home/markl/Crypto/Hyperliquid/test/processed"
RAW_FILE="/home/markl/Crypto/Hyperliquid/test/raw/2026/05/01.txt"
...
echo "=== Hyperliquid Processor Benchmark ==="
echo "Input: $RAW_FILE"
echo "Lines: $LINES"
...
# Check output
OUTPUT_FILE="$PROCESSED_DIR/2026/05/01"
